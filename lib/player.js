...
//        glMatrix.mat4.fromRotationTranslationScaleOrigin(out, quat, [0,0,1], [1,1,1], [0,0,0])
...
//        this.moveDir = new Vector3(x,y,z)
    ...
    /*
        ...
        fixedUpdate(deltaTime) {
        var input = InputManager.readInput().scaled(this.turnPower)
        this.transform.rotation.z += (input.x * 180 / Math.PI) % 360
        this.transform.rotation.x += (input.y * 180 / Math.PI) % 360

//        this.moveDir.x = this.transform.rotation.x
//        this.moveDir.y = this.transform.rotation.y
//        this.moveDir.z = this.transform.rotation.z
