...
class TextureLoader {
    ...
    loadTextures() {
        ...
        this.loadTexture("./Assets/defaultTexture.png", "default")
        this.loadTexture("./Assets/crate.png", "crate")
        this.loadTexture("./Assets/burningCrate.png", "burningCrate");
        this.loadTexture("./Assets/SusanTexture.png", "susan");
        this.loadTexture("./Assets/rocketTexture.png", "redRocket");
        this.loadTexture("./Assets/rocketTexture2.png", "blueRocket");
        this.loadTexture("./Assets/rocky-texture.jpg", "rock");
        this.loadTexture("./Assets/laser.png", "laser");
    }
